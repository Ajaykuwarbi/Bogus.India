...
[![NuGet](https://img.shields.io/nuget/v/Bogus.India.svg)](https://www.nuget.org/packages/Bogus.India)
[![NuGet Downloads](https://img.shields.io/nuget/dt/Bogus.India.svg)](https://www.nuget.org/packages/Bogus.India)
...
```bash
dotnet add package Bogus.India
```

Or via the NuGet Package Manager:

```
Install-Package Bogus.India
```
